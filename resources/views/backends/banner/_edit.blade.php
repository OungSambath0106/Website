...
<div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
        ...
        <form action="{{ route('admin.banner.update', $banner->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label"
                                    for="exampleInputFile">{{ $banner->banners ? basename($banner->banners) : __('Choose file') }}</label>
                            </div>
                        </div>
                        <div class="preview preview-multiple text-center border rounded mt-2" style="height: 150px">
                            <img src="
                            @if ($banner->banners && file_exists(public_path('uploads/banner/' . $banners->banners))) @else
